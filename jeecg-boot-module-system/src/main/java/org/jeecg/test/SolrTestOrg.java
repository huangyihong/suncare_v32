...
//        ApplicationContext context = SpringContextUtils.getApplicationContext();
        ...
        initProp();
        String batchId = "7296e6d06940fa811fa457f258ec9d55";
        String path = "E:/ASIAProject/suncare_v3/excel/2019药品结果统计字段-机构" + batchId +".xls";
        ...
        String expr = "facet(MEDICAL_UNREASONABLE_DRUG_ACTION,q=\"BATCH_ID:" + batchId + "\"" +
                ",fq=\"{!join from=VISITID fromIndex=DWB_MASTER_INFO to=VISITID}VISITDATE:2019*\",bucketSorts=\""+fields[0] +" asc\",count(*)" +
                ",rows=" + MAX_ROW + ",buckets=\"" + fields[0] + "," + fields[1] +"\",sum(FEE))";
