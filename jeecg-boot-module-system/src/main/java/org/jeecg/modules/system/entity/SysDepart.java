...
public class SysDepart implements Serializable {
	...
	/**用户报告类别*/
	@Excel(name="用户报告类别",width=15)
	private String roleType;
	/**分析模板名称*/
	@Excel(name="分析模板名称",width=15)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, depart.id) &&
				...
				Objects.equals(province,depart.getProvince())&&
				Objects.equals(city,depart.getCity())&&
				Objects.equals(county,depart.getCounty())&&
				Objects.equals(county,depart.getRoleType())&&
				Objects.equals(county,depart.getTemplateIds());
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash(super.hashCode(), id, parentId, departName, 
        		...
        		delFlag, createBy, createTime, updateBy, updateTime,province,city,county,roleType,templateIds);
    }
}
