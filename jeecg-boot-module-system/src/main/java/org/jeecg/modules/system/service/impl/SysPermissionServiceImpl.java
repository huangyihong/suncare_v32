...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	@Override
	public List<SysPermission> queryByUserSystemCode(String username,String systemCode) {
		return this.sysPermissionMapper.queryByUserSystemCode(username,systemCode);
	}
