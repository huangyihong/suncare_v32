...
//		log.info("无缓存dictTable的时候调用这里！");
	...
	@Override
	@Cacheable(value = CacheConstant.SYS_DICT_TABLE_CACHE)
	public List<String> queryTableDictByKeys(Map<String, String> query,String table, String text, String code, String[] keyArray) {
		List<DictModel> dicts = sysDictMapper.queryTableDictByKeys(query,table, text, code, keyArray);
