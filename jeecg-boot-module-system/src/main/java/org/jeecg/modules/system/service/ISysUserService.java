...
public interface ISysUserService extends IService<SysUser> {
	 ...
	 * @param suffix
	 */
    boolean exportExcel(List<SysUserVO> listVO, OutputStream os, String suffix) throws Exception;

	Result<?> importExcelNew(MultipartFile file, MultipartHttpServletRequest multipartRequest) throws Exception;
