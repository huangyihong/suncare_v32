...
public interface SysDictMapper extends BaseMapper<SysDict> {
	...
	public List<DictModel> queryTableDictByKeys(@Param("query") Map<String, String> query,@Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("keyArray") String[] keyArray);
