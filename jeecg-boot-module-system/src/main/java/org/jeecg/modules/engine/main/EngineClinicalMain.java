...
public class EngineClinicalMain {
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			IEngineClinicalService service = context.getBean(IEngineClinicalService.class);
			
			String batchId = args[0];
			service.generateUnreasonableAction(batchId);
			//service.generateMedicalUnreasonableClinicalAction(batchId, "6f4b831d754c4eb293cef93e1d9ef5e9");
		} catch(Exception e) {
			log.error("", e);
		} finally {			
