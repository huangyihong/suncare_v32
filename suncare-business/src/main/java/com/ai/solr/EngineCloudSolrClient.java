/**
 * EngineCloudSolrClient.java	  V1.0   2021年11月5日 上午11:38:50
 *
...
public class EngineCloudSolrClient extends CloudSolrClient {
	/**
	 * serialVersionUID
	 */
	...
	public EngineCloudSolrClient(Builder builder, SolrAuth auth) {
		super(builder);
		this.auth = auth;
	}
	...
	public static class EngineBuilder extends CloudSolrClient.Builder {

		public EngineBuilder(List<String> zkHosts, Optional<String> zkChroot) {
