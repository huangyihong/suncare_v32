 ...
 */
@Data
@TableName("yb_fj_project_clue_cut")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="yb_fj_project_clue_cut对象", description="飞检项目终审确认线索表")
public class YbFjProjectClueCut {
	...
	private java.lang.Object caseRemark;
	/**核减数量*/
	...
	private java.lang.Object sureBasis;
	/**审核结果(init:待核减 finish 已核减)*/
	@Excel(name = "审核结果(init:待核减 finish 已核减)", width = 15)
	@ApiModelProperty(value = "审核结果(init:待核减 finish 已核减)")
	...
	private java.lang.Object auditOpinion;
	/**创建时间*/
