 ...
 */
@Data
@TableName("yb_fj_project_clue_dtl")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="yb_fj_project_clue_dtl对象", description="飞检项目线索明细")
public class YbFjProjectClueDtl {
	...
	/**关联yb_fj_project_org.id*/
	@Excel(name = "关联yb_fj_project_org.id", width = 15)
    @ApiModelProperty(value = "关联yb_fj_project_org.id")
	private String projectOrgId;
	/**yb_fj_project_clue.id*/
	@Excel(name = "yb_fj_project_clue.id", width = 15)
    @ApiModelProperty(value = "yb_fj_project_clue.id")
