 ...
 */
@Data
@TableName(value="MEDICAL_FORMAL_FLOW_RULE", autoResultMap=true)
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="MEDICAL_FORMAL_FLOW_RULE对象", description="模型归纳规则列表")
public class MedicalFormalFlowRule {
