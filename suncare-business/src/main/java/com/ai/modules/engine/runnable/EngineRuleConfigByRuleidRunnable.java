 ...
 */
public class EngineRuleConfigByRuleidRunnable extends AbsEngineRunnable {
	
	private String batchId;
	private String ruleId;

	public EngineRuleConfigByRuleidRunnable(String datasource, String batchId, String ruleId) {
		super(datasource);
	...
	public void execute() throws Exception {
		...
		service.generateUnreasonableActionByRule(batchId, ruleId);
	}
}
