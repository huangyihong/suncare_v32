 ...
 */
public class ChargeOnedayMutexHandle extends AbsSecondaryHandle {

	public ChargeOnedayMutexHandle(String batchId, String itemCode, List<MedicalDrugRule> ruleList, boolean trail) {
	...
	public void execute() throws Exception {
    	...
    	String limitScopeCode = EngineLimitScopeEnum.CODE_29.getCode();
    	//限制范围
     ...
     * <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
     */
    private void writeSplitMutex(BufferedWriter fileWriter, MutexComputeVO computeVO, ItemVO mutexVO, boolean create) {
