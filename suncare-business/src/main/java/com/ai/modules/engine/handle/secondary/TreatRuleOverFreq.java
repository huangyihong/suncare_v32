 ...
 */
@Slf4j
public class TreatRuleOverFreq extends RuleOverFrequency {

	public TreatRuleOverFreq(TaskProject task, TaskProjectBatch batch, MedicalRuleConfig rule, List<MedicalRuleConditionSet> ruleConditionList,
			Boolean trail) {
