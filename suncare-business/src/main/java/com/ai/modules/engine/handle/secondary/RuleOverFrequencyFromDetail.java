 ...
 */
@Slf4j
public class RuleOverFrequencyFromDetail extends AbsRuleSecondHandle {

	public RuleOverFrequencyFromDetail(TaskProject task, TaskProjectBatch batch, MedicalRuleConfig rule, List<MedicalRuleConditionSet> ruleConditionList,
			Boolean trail) {
