 ...
 */
public interface IEngineChargeService extends IEngineBaseService {

	/**
	 *
	 * 功能描述：按每个收费项目的所有规则计算违规数据
	 *
	 * @author  zhangly
	 ...
	 * <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
	 */
	void generateMedicalUnreasonableChargeAction(TaskProject task, TaskProjectBatch batch, String itemCode, List<MedicalDrugRule> ruleList) throws Exception;

    void generateMedicalUnreasonableChargeActionByThreadPool(String batchId);
	...
	void trailChargeActionThreadPool(String ruleId, String etlSource);
	/**
	 *
	 * 功能描述：收费不合规行为试算
	 *
	 ...
	 * <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
	 */
	void trailChargeAction(String ruleId, String etlSource, String datasource);
}
