 ...
 */
public class EngineChargeRunnable extends AbsEngineRunnable {	
	private TaskProject task;
	private TaskProjectBatch batch;
	private String itemcode;
	private List<MedicalDrugRule> ruleList;

	public EngineChargeRunnable(String datasource, boolean redo, TaskProject task, TaskProjectBatch batch,
	...
	public void execute() throws Exception {
		IEngineChargeService service = SpringContextUtils.getApplicationContext().getBean(IEngineChargeService.class);
		service.generateMedicalUnreasonableChargeAction(task, batch, itemcode, ruleList);
	}
}
