 ...
 */
public class ClinicalDrugGrpRuleHandle extends AbsClinicalRuleHandle {

	public ClinicalDrugGrpRuleHandle(String tableName, String colName, String compareValue) {
	...
	protected String handler() {
		...
		queryWrapper.inSql("GROUP_ID", "SELECT GROUP_ID FROM MEDICAL_DRUG_GROUP WHERE GROUP_CODE in"+where);
		...
		sb.append("DRUGGROUP_CODE").append(":").append(where);
		return sb.toString();
	}
}
