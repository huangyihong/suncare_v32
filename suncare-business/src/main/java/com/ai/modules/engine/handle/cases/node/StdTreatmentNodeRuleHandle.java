...
public class StdTreatmentNodeRuleHandle extends AbsTemplateNodeRuleHandle {
	
	public StdTreatmentNodeRuleHandle(EngineNodeRule rule) {
		super(rule);
	}
	...
	public String where(boolean ignoreJoin) {
		...
		sb.append("_query_:\"");
		EngineMapping mapping = new EngineMapping(EngineUtil.DWS_PATIENT_1VISIT_ITEMSUM, "VISITID", "VISITID");
	...
	public String handler() {
		StringBuilder sb = new StringBuilder();
		sb.append("_query_:");
		EngineMapping mapping = new EngineMapping("STD_TREATMENT", "TREATCODE", "ITEMCODE");
		SolrJoinParserPlugin plugin = SolrJoinParserPlugin.build(mapping);
		sb.append(plugin.parse());
	...
	public String template() {
		...
		sb.append(plugin.parse());
		sb.append("_query_:\\\"");
		mapping = new EngineMapping("STD_TREATMENT", "TREATCODE", "ITEMCODE");
