 ...
 * @Version: V1.0
 */
public interface IMedicalProjectGroupService extends IService<MedicalProjectGroup> {

	void saveGroup(MedicalProjectGroup medicalProjectGroup, String codes, String names, String tableTypes);

	void updateGroup(MedicalProjectGroup medicalProjectGroup, String codes, String names, String tableTypes);
    ...
    List<MedicalGroupVO> queryGroupItemByGroupCodes(List<String> projectGroupCodes);

	List<MedicalGroupVO> queryGroupItem2(QueryWrapper<MedicalProjectGroup> queryWrapper);
	int queryGroupItemCount2(QueryWrapper<MedicalProjectGroup> queryWrapper);
}
