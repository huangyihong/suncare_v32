 ...
 */
@Data
@TableName(value="MEDICAL_DISEASE_DIAG", autoResultMap=true)
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="MEDICAL_DISEASE_DIAG对象", description="ICD国际疾病维护")
public class MedicalDiseaseDiag {
	...
	/**疾病类别码*/
	@Excel(name = "疾病类别码", width = 15)
    @ApiModelProperty(value = "疾病类别码")
	private java.lang.String typeCode;
	/**疾病类别名称*/
	@Excel(name = "疾病类别名称", width = 15)
