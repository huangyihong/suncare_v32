 ...
 */
@Data
@TableName(value="STD_WJ_ITEMCATALOG", autoResultMap=true)
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="STD_WJ_ITEMCATALOG对象", description="医疗服务项目物价目录")
public class StdWjItemcatalog {
	...
	/**项目规格*/
	@Excel(name = "项目规格", width = 15)
    @ApiModelProperty(value = "项目规格")
	private java.lang.String specificaion;
	/**项目包装*/
	@Excel(name = "项目包装", width = 15)
    @ApiModelProperty(value = "项目包装")
	private java.lang.String pack;
	/**项目生产企业编码*/
	@Excel(name = "项目生产企业编码", width = 15)
    @ApiModelProperty(value = "项目生产企业编码")
	private java.lang.String manufactorCode;
	/**项目生产企业名称*/
	@Excel(name = "项目生产企业名称", width = 15)
    @ApiModelProperty(value = "项目生产企业名称")
	...
	/**政策文件名称*/
	@Excel(name = "政策文件名称", width = 15)
    @ApiModelProperty(value = "政策文件名称")
