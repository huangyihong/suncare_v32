 ...
 * @Version: V1.0
 */
public interface IStdWjItemcatalogService extends IService<StdWjItemcatalog> {
    ...
    boolean exportExcel(List<StdWjItemcatalog> list, OutputStream os, String suffix) throws Exception;
