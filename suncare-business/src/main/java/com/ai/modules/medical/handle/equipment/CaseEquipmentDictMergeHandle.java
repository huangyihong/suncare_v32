 ...
 */
public class CaseEquipmentDictMergeHandle extends AbsCaseDictMergeHandle {

	@Override
	public List<DictMergeVO> merge(String main, String repeat) throws Exception {
		CaseDictMergeHandle handle = new CaseDictMergeHandle("ITEMCODE");
