...
//		log.error(e.getMessage());
		...
		return Result.error("操作失败，" + (msg.length() > 1000?msg + "...": msg));
	}
	...
	public Result<?> handleSQLRecoverableException(SQLRecoverableException e) {
		log.error("SQLRecoverableException:" + e.getMessage());
		return Result.error("Redis 连接异常!");
	}
}
